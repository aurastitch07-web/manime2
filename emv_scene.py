...
class EMV(Scene):
    ...
    def normal_section(self):
        ...
        likelihood = MathTex(
            r"L({{\mu}})", r"=", r"\prod_{i=1}^n", r"f({{x_i}})",
    ...
    def poisson_section(self):
        ...
        likelihood = MathTex(
            r"L({{\lambda}})", r"=", r"\prod_{i=1}^n e^{-{{\lambda}}}\frac{{{\lambda}}^{{{x_i}}}}{{{x_i}}!}",
            r"=", r"e^{-n{{\lambda}}}\frac{{{\lambda}}^{\sum {{x_i}}}}{\prod {{x_i}}!}",
            font_size=42,
        )
        ...
        log_wrap = MathTex(
            r"\ln(L({{\lambda}}))", r"=", r"\ln\Big[",
            r"e^{-n{{\lambda}}}\frac{{{\lambda}}^{\sum {{x_i}}}}{\prod {{x_i}}!}",
            r"\Big]",
            font_size=42,
        )
        ...
        log_simplified = MathTex(
            r"\ln L({{\lambda}})", r"=", r"-n{{\lambda}}", r"+", r"\left(\sum {{x_i}}\right)\ln({{\lambda}})", r"-", r"\ln(\prod {{x_i}}!)",
            font_size=42,
        )
    ...
    def bernoulli_section(self):
        ...
        likelihood = MathTex(
            r"L({{p}})", r"=", r"\prod_{i=1}^n {{p}}^{{{x_i}}}(1-{{p}})^{1-{{x_i}}}",
            r"=", r"{{p}}^{\sum {{x_i}}}(1-{{p}})^{n-\sum {{x_i}}}",
            font_size=42,
        )
        ...
        log_wrap = MathTex(
            r"\ln(L({{p}}))", r"=", r"\ln\Big[{{p}}^{\sum {{x_i}}}(1-{{p}})^{n-\sum {{x_i}}}\Big]",
            font_size=42,
        )
        ...
        log_simplified = MathTex(
            r"\ln L({{p}})", r"=", r"(\sum {{x_i}})\ln({{p}})", r"+", r"(n-\sum {{x_i}})\ln(1-{{p}})",
            font_size=42,
        )
    ...
    def uniform_section(self):
        ...
        likelihood = MathTex(
            r"L({{\theta}}) = \frac{1}{{{\theta}}^n} \mathbb{1}_{\max({{x_i}}) \le {{\theta}}}",
            font_size=42,
        )
        ...
        theta_hat = MathTex(
            r"\hat{{\theta}}", r"=", r"\max({{X_1}}, \dots, {{X_n}}) = X_{(n)}",
            font_size=42,
        )
